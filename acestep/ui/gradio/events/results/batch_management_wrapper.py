...
def generate_with_batch_management(
    ...
    extend_overlap_seconds, custom_timesteps, audio_format, mp3_bitrate, mp3_sample_rate,
    lm_temperature,
    ...
    saved_params = _build_saved_params(
        ...
        use_adg, cfg_interval_start, cfg_interval_end, shift, infer_method,
        sampler_mode, velocity_norm_threshold, velocity_ema_factor,
        extend_overlap_seconds, audio_format, mp3_bitrate, mp3_sample_rate, lm_temperature,
        think_checkbox, lm_cfg_scale, lm_top_k, lm_top_p, lm_negative_prompt,
